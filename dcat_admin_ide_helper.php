...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection is_branch
     * @property Grid\Column|Collection oil
     * @property Grid\Column|Collection oil_capacity
     * @property Grid\Column|Collection facilities
     * @property Grid\Column|Collection tables
     * @property Grid\Column|Collection cockroaches
     ...
     * @method Grid\Column|Collection is_branch(string $label = null)
     * @method Grid\Column|Collection oil(string $label = null)
     * @method Grid\Column|Collection oil_capacity(string $label = null)
     * @method Grid\Column|Collection facilities(string $label = null)
     * @method Grid\Column|Collection tables(string $label = null)
     * @method Grid\Column|Collection cockroaches(string $label = null)
     ...
     * @property Show\Field|Collection is_branch
     * @property Show\Field|Collection oil
     * @property Show\Field|Collection oil_capacity
     * @property Show\Field|Collection facilities
     * @property Show\Field|Collection tables
     * @property Show\Field|Collection cockroaches
     ...
     * @method Show\Field|Collection is_branch(string $label = null)
     * @method Show\Field|Collection oil(string $label = null)
     * @method Show\Field|Collection oil_capacity(string $label = null)
     * @method Show\Field|Collection facilities(string $label = null)
     * @method Show\Field|Collection tables(string $label = null)
     * @method Show\Field|Collection cockroaches(string $label = null)
